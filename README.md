...
[Result,Summary,fig] = runRapidPDPaper( ...
    rx_2_260904_171616_1M, rx_2_260904_180803_NO, ...
    'paper_acf_layers',2,'paper_time_aggregation','mean');
```

不取单个lag指标，直接查看完整的一层ACF：

```matlab
[Result,figCurve,figHeatmap] = plotRapidPDFirstLayerACF( ...
    rx_2_260904_171616_1M, rx_2_260904_180803_NO);
```

该入口分别输出Rx1/Rx2的一人和无人完整平均ACF曲线，以及每个20包窗口的完整ACF热力图；横轴保留全部子载波索引延迟，不计算运动分数。
